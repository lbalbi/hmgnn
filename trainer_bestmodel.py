...
class Train_BestModel:
    ...
    def train_epoch(self):
        ...
        for batch in self.train_loader:
            ...
            neg_src, neg_dst = self.neg_sampler.sample()#.to(self.device)
            ...
            if not self.no_contrastive:
                ...
                else: z_pos, z_pos_pos, z_pos_neg = self.neg_statement_sampler.get_contrastive_samples(z)
    ...
    def test_epoch(self):
        ...
        for batch in self.test_loader:
            ...
            if self.model.__class__.__name__ in {"GCN", "GAT", "GCN_GAE"}:
                ...
                dst = edge_index[1] + offsets[n_type]
                mapped_pairs = torch.stack([src, dst], dim=0)
                with torch.no_grad(): z, out = self.model(hom_data, mapped_pairs)
            else:
