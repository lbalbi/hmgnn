...
from losses import DualContrastiveLoss_CE, DualContrastiveLoss_Margin, ProteinContrastiveLoss
...
class Train_BestModel:
    def __init__(self, model, epochs, train_loader, val_loader, full_cvgraph,
        ...
        if self.rstatement_sampler:
            ...
            self.neg_statement_sampler = NegativeProteinSampler(anchor_etype=e_type)
        ...
        self.earlystopper = EarlyStopping(patience_ = patience)
        self.log = log
        self.task = task
        ...
        for batch in self.train_loader:
            ...
            if not self.no_contrastive:
                if self.rstatement_sampler:
                    ...
                    samples = self.neg_statement_sampler.get_contrastive_samples(z, neg_statement_index)
