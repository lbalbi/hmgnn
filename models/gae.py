...
class Hadamard_MLPPredictor(nn.Module):
    def __init__(self, h_feats, dropout, layer=5, res=True, norm=False, scale=False, act='relu'):
        super().__init__()
...
class GCN(nn.Module):
    def __init__(self, in_feats, h_feats, drop_edge=False, relu=False, linear=False, 
                 prop_step=2, dropout=0.2, residual=0.1):
